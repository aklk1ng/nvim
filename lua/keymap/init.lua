...
_G.map('n', 'grn', _G.cmd('Lspsaga rename'))
_G.map('n', '<leader>rn', _G.cmd('Lspsaga rename ++project'))

_G.map('n', '<leader>ff', _G.cmd('Telescope find_files'))
...
_G.map('n', '<leader>fl', _G.cmd('Telescope live_grep'))
_G.map('n', '<leader>/', _G.cmd('Telescope current_buffer_fuzzy_find'))
_G.map('n', '<leader>fg', _G.cmd('Telescope git_status'))
_G.map('n', '<leader>fr', _G.cmd('Telescope lsp_references'))
_G.map('n', '<leader>fi', _G.cmd('Telescope lsp_implementations'))

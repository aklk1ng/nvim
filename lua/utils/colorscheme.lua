...
local syntax = {
  ...
  FoldColumn = { fg = M.base3, bg = M.bg },
  CursorLine = { bg = M.bg_highlight },
  LineNr = { fg = M.base3 },
  CursorLineNr = { fg = M.grey_1, bold = true },
  DiffAdd = { fg = M.green, bg = M.base2 },
  DiffChange = { fg = M.blue, bg = M.base2 },
  DiffDelete = { fg = M.red, bg = M.base2 },
  ...
  NonText = { fg = M.bg1 },
  Whitespace = { fg = M.base2 },
  SpecialKey = { fg = M.bg1 },
  Pmenu = { fg = M.fg, bg = '#2E323E' },
  PmenuSel = { fg = M.base0, bg = M.blue },
  PmenuSelBold = { fg = M.base0, bg = M.blue },
  PmenuSbar = { bg = M.base2 },
  PmenuThumb = { fg = M.pink, bg = M.light_green },
  WildMenu = { fg = M.bg1, bg = M.green },
  StatusLine = { fg = M.base5, bg = M.base1 },
  StatusLineNC = { fg = M.grey, bg = M.base1 },
  NormalFloat = { fg = M.base5, bg = M.bg_highlight },
  Tabline = { fg = M.fg, bg = M.bg },
  TabLineSel = { fg = M.fg, bg = M.base2 },

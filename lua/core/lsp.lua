...
_G._capabilities = require('blink.cmp').get_lsp_capabilities()
...
local function on_attach(client, bufnr)
  ...
  if client:supports_method(methods.textDocument_signatureHelp) then
    vim.keymap.set({ 'i', 's' }, '<C-k>', vim.lsp.buf.signature_help, { buffer = bufnr })
  end
  ...
  if client:supports_method(methods.textDocument_definition) then
    ...
    vim.keymap.set('n', 'gD', _G.cmd('FzfLua lsp_definitions'), { buffer = bufnr })
  end

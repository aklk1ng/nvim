...
setlocal tabstop=2
nnoremap <silent><buffer> <to>   :call <SID>toggleTodoStatus()<CR>
...
nnoremap <silent><buffer> <F4> :call <SID>toggleMPTheme()<CR>
inoremap <silent><buffer> <F4> <ESC>:call <SID>toggleMPTheme()<CR>
fun! s:toggleMPTheme()

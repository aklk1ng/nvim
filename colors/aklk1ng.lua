...
local syntax = {
  ...
  SpecialKey = { fg = p.fg },
  Pmenu = { fg = p.fg_dim, bg = p.shade_1 },
  PmenuKind = { fg = p.yellow, bg = p.shade_1 },
  PmenuSel = { fg = p.fg_dim, bg = p.shade_2 },
  PmenuMatch = { fg = p.green, bg = p.shade_1 },
  ...
  ['@markup.raw.block.markdown'] = { fg = p.fg_dim },
  ['@macro'] = { fg = p.pink },
  ['@markup'] = { fg = p.fg_dim },
  ...
  ['@markup.heading.4'] = { fg = p.shade_4, bold = true },
